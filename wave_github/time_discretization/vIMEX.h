...
#ifndef TIME_INTEGRATION_VIMEX_H_
#define TIME_INTEGRATION_VIMEX_H_
...
template <int dim>
class vIMEX : public TimeIntegrator<dim>{
public:
	vIMEX(const SparseMatrix<double>& M,
...
#endif /* TIME_INTEGRATION_VIMEX_H_ */
